...
**XAI-Driven Diabetes Prediction**

- Built ML models on the **Pima Indian Diabetes Dataset**
- Applied **SHAP and LIME** to improve interpretability and clinical trust
- Evaluated performance–transparency tradeoffs
- **Presented at ICMAAI-25**; publication forthcoming in IJTE (UGC Care)

**Focus:** Data Analysis · Applied ML  
**Tech:** Python, Scikit-learn, XAI
...
**Focus:** Applied ML · Model Evaluation  
**Tech:** YOLO, OpenCV
...
- Deployed analytics-ready infrastructure on AWS
